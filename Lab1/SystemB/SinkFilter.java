...
public class SinkFilter extends FilterFramework {
    public void run() {
        ...
        // Changed date format to match System B requirements
        ...
        double velocity = 0;
        // stored as String to handle asterisk
        String altitudeStr = "0.0";
        double pressure = 0;
        ...
        try {
            ...
            // Open output file
            pw = new PrintWriter(new FileWriter("Output/OutputB.csv"));
            // Write header
            pw.println("Time,Velocity,Altitude,Pressure,Temperature");
        } catch (IOException e) {
        ...
        while (true) {
            try {
				...
				****************************************************************************/
                // Store measurements based on ID
                if (id == 1) { // Velocity
                    velocity = Double.longBitsToDouble(measurement);
                } else if (id == 2) { // Altitude (Standard)
                    altitudeStr = String.valueOf(Double.longBitsToDouble(measurement));
                } else if (id == 6) { // Altitude (Replaced - Wild Jump found)
                    altitudeStr = Double.longBitsToDouble(measurement) + "*";
                } else if (id == 3) { // Pressure
                    pressure = Double.longBitsToDouble(measurement);
                } else if (id == 4) { // Temperature
