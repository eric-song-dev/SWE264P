...
/**
 * This class represents a record of a student. This class contains a student's
 * personal information
 * and the course numbers the student has completed. This class is constructed
 * from a field-oriented
...
public class Student implements Serializable {
    ...
    /**
     * A list containing the courses this student is registered for. Elements in the
     * list are
     ...
     * <code>sInput</code> is
     * field-oriented and space-separated string. The first three required fields
     * are student ID,
    ...
    /**
     * Test if the given string <code>sSID</code> is equal to the ID of this student
     * record.
     *
     * @param sSID a string representing a student ID
     * @return <code>true</code> if <code>sSID</code> is equal to the ID of this
     *         student record
     ...
     *
     * @return the courses this student has registered for as an
     ...
     *
     * @return the courses this student has completed as an <code>ArrayList</code>
     *         of
     *         <code>Course</code>s
    ...
    /**
     * Returns a string representation of this student record. The resulting string
     * will be in the
