...
/**
 * This class represents a record of a course. This class contains a course's
 * general information
 * and the students who have registered this course. This class is constructed
 * from a
 * field-oriented and space-separated string. For the detailed format of such a
 * string refer to
 * {@link #Course(String)}.
 *
 * @author Jung Soo Kim
...
public class Course implements Serializable {
    ...
    /**
     * A list containing the students who registered for this course. Elements in
     * the list are
    ...
    /**
     * Constructs a course record by parsing the given string. The string
     * <code>sInput</code> is
     * field-oriented and space-separated. The seven required fields are course ID,
     * section, class
     ...
     * <p>
     * Though not necessary, avoid embedding newline characters in the
     * <code>sInput</code> string.
     *
    ...
    /**
     * Test if the given string <code>sCID</code> is equal to the ID of this course
     * record.
     *
     * @param sCID a string representing a course ID
     * @return <code>true</code> if <code>sCID</code> is equal to the ID of this
     *         course record
    ...
    /**
     * Test if the given strings <code>sCID</code> and <code>sSection</code> are
     * equal to ID and
     * section of this course record respectively.
     *
     * @param sCID     a string representing a course ID
     * @param sSection a string representing a course section
     * @return <code>true</code> if <code>sCID</code> and <code>sSection</code> are
     *         equal to the ID
    ...
    /**
     * Test if the given course record <code>objCourse</code> and this course record
     * have any time
     * conflict.
     *
     * @param objCourse a course object to test
     * @return <code>true</code> if <code>objCourse</code> conflicts with this
     *         course record
     */
     ...
     *
     * @return the students who registered for this course as an
    ...
    /**
     * Returns a string representation of this course record. The resulting string
     * will be in the
    ...
    public String toString() {
        // Create a string to return with course ID, name, and program, course ID,
        // section, class
